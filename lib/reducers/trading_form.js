...
export default (state = initialState, error = Immutable.Map(), action) => ActionsHandlers[actions_types[action.type]] ? ActionsHandlers[actions_types[action.type]](state, error, action) : [state, error];
